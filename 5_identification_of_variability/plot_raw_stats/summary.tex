...
%
     ...
     snp\_f & 28.4\% & 0.57 & 35.9\% & 6 &0 \\ 
 \end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
        \item snp\_f .. \texttt{\footnotesize snp\_freebayes.vcf.gz}
...
% Fraction of SNVs with VAF$<$25\% by sample
%
\hslide{Fraction of SNVs with VAF$<$25\% by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{vaf25.snv.0}.png}}}}
        
% Fraction of indels with VAF$<$25\% by sample
%
\hslide{Fraction of indels with VAF$<$25\% by sample}{\vbox{\centerline{\includegraphics[height=7cm]{{vaf25.indel.0}.png}}}}
...
% SNV Variant Allele Frequency
%
\hslide{SNV Variant Allele Frequency}{\includegraphics[width=15cm]{{vaf.snv.0}.png}}
        
% Indel Variant Allele Frequency
%
\hslide{Indel Variant Allele Frequency}{\includegraphics[width=15cm]{{vaf.indel.0}.png}}
